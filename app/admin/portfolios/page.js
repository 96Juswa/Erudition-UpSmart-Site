...
// You'll copy the component from the artifact into a separate file
import PortfolioApprovalDashboard from "@/components/admin/PortfolioApprovalDashboard";
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-bold">Admin Portal - Portfolios</h1>
            </div>
          </div>
